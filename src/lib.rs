...
static GITHUB_REPO: &'static str = "huacnlee/autocorrect";
static BIN_NAME: &'static str = "autocorrect";
...
impl AutoCorrectExtension {
    fn language_server_binary_path(
        ...
        let version_dir = format!("autocorrect-{}", release.version);
